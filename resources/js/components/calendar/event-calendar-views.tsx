...
import type { CalendarOptions, DayCellInfo } from '@fullcalendar/react';
...
export function EventCalendarViews({
    ...
    return (
        ...
        ----------------------------------------------------------------------------------------- */
            ...
            listDayClass={(info) =>
                cn('flex flex-col', !info.isLast && 'border-b')
            }
        ...
        ----------------------------------------------------------------------------------------- */
            ...
            ------------------------------------------------------------------------------------- */
                    ...
                    listItemEventBeforeClass:
                        'w-1.5 bg-(--fc-event-color) rounded-full',
