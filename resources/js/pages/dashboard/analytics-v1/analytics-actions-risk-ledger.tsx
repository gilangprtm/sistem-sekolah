...
const ledgerColumns: ColumnDef<LedgerRow>[] = [
    {
        ...
        cell: ({ row }) => (
            <div className="flex flex-col gap-1">
                <p className="text-sm font-medium">{row.original.account}</p>
    ...
    },
    {
        ...
        header: 'Blocker',
        cell: ({ row }) => (
            <div className="max-w-44 text-xs whitespace-normal">
...
function LedgerStat({
    ...
    return (
        <div className="flex flex-col gap-1 px-0 sm:px-3 first:sm:pl-0 last:sm:pr-0">
