        ...
        <Card className="shadow-xs">
            ...
            <CardContent className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                    Coverage below target. Prioritize qualified volume and
                    shorter cycle time.
                </p>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-xs">
                        ...
                        <span className="text-muted-foreground">
                            ...
                            <span className="text-foreground">
                                top gap-filling deals
                            </span>
                        </span>
                        <span className="text-muted-foreground">
                            Due:{' '}
                            <span className="text-foreground">
                                before next forecast call
                            </span>
                        </span>
                    </div>
                    <Button
                ...
                <div className="space-y-1 rounded-md border border-dashed bg-muted/10 px-3 py-2.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Priority sequence:{' '}
                        <span className="text-foreground">cycle time</span>{' '}
                        before net-new volume.
                    </p>
                </div>
            </CardContent>
        </Card>
