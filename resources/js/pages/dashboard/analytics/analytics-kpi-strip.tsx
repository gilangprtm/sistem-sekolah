                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            <span>
                                from{' '}
                                <span className="text-foreground">207.3k</span>
                            </span>
                            <span>•</span>
                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            <span>
                                from{' '}
                                <span className="text-foreground">243.5k</span>
                            </span>
                            <span>•</span>
                            <span>last 4 weeks</span>
                        </div>
                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            <span>
                                from{' '}
                                <span className="text-foreground">566.8k</span>
                            </span>
                            <span>•</span>
                            <span>last 4 weeks</span>
                        </div>
                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            <span>
                                from{' '}
                                <span className="text-foreground">58.9%</span>
                            </span>
                            <span>•</span>
                            <span>last 4 weeks</span>
                        </div>
