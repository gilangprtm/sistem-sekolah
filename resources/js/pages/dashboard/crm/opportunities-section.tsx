...
export function OpportunitiesSection() {
    ...
    const stageFilter =
        (table.getColumn('stage')?.getFilterValue() as string | undefined) ??
        'all';
    const healthFilter =
        (table.getColumn('health')?.getFilterValue() as string | undefined) ??
        'all';
        ...
        <section>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Track qualified leads moving through discovery,
                        proposal, and closing stages.
                    </CardDescription>
                    <CardAction>
                ...
                <CardContent className="flex flex-col gap-4 px-0">
                    <div className="overflow-hidden">
                        <Table className="**:data-[slot='table-cell']:px-4 **:data-[slot='table-cell']:py-4 **:data-[slot='table-head']:px-4">
                            <TableHeader className="border-t **:data-[slot='table-head']:h-11 **:data-[slot='table-head']:text-sm **:data-[slot='table-head']:font-medium **:data-[slot='table-head']:text-foreground">
                    ...
                    <div className="flex items-center justify-between gap-4 px-4 pb-1">
                        <p className="text-sm text-muted-foreground">
                            ...
                            {filteredOpportunityCount.toLocaleString()}{' '}
                            opportunities
                        </p>
