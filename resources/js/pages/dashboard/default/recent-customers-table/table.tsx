...
export function RecentCustomersTable({ data }: { data: RecentCustomerRow[] }) {
    ...
    const joinedDateFilter =
        (table.getColumn('joinedWindow')?.getFilterValue() as
    ...
    const sortValue = React.useMemo(() => {
        ...
        if (currentSort.id === 'joined' && currentSort.desc) {
            return 'newest';
        }
        ...
        if (currentSort.id === 'name' && !currentSort.desc) {
            return 'name-asc';
        }
                        ...
                        <DropdownMenuContent align="end">
                            <DropdownMenuRadioGroup
                                ...
                                onValueChange={(value) => {
                                    table.setSorting(
                                        sortOptionState[
                                            value as keyof typeof sortOptionState
