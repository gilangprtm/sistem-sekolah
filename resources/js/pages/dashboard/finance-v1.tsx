...
import { CardOverview } from './finance-v1/card-overview';
import { CashFlowOverview } from './finance-v1/cash-flow-overview';
import { IncomeReliability } from './finance-v1/income-reliability';
import { MonthlyCashFlow } from './finance-v1/kpis/monthly-cash-flow';
import { NetWorth } from './finance-v1/kpis/net-worth';
import { PrimaryAccount } from './finance-v1/kpis/primary-account';
import { SavingsRate } from './finance-v1/kpis/savings-rate';
import { SpendingBreakdown } from './finance-v1/spending-breakdown';
