    ...
    return (
        <Card className="shadow-xs">
            <CardHeader className="items-center">
                ...
                <CardDescription>
                    1 of 4 cards added · Overview of your primary card and
                    upcoming payments
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    <div className="grid w-full place-items-center">
                        <div className="relative flex aspect-8/5 w-full max-w-100 flex-col justify-between overflow-hidden rounded-xl bg-primary p-6">
                            ...
                            <div className="space-y-1">
                                <p className="font-mono text-sm tracking-[0.15em] text-primary-foreground/90 sm:text-lg">
                                    •••• •••• •••• 2301
                                </p>
                            </div>
                            ...
                            <div className="flex items-end justify-between">
                                <div className="space-y-2">
                                    <p className="font-mono text-sm font-medium tracking-wide text-primary-foreground uppercase">
                                        Arham Khan
                                    </p>
                                    <div className="flex gap-6">
                                        <div>
                                            <p className="text-[10px] tracking-wider text-primary-foreground/80 uppercase">
                                                Valid Thru
                                            </p>
                    ...
                    <div className="space-y-4">
                        <h6 className="text-sm text-muted-foreground uppercase">
                            Upcoming Payments
                        </h6>
                            ...
                            {upcomingPayments.map((transaction) => (
                                ...
                                >
                                    ...
                                    <div className="flex w-full items-end justify-between">
                                        ...
                                        <div>
                                            <span className="text-sm leading-none font-medium text-destructive tabular-nums">
                                                {formatCurrency(
                                                    transaction.amount,
                                                    {
                                                        noDecimals: true,
