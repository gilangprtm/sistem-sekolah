    ...
    return (
        <div className="overflow-hidden rounded-xl bg-card ring-1 ring-foreground/10">
            <div className="grid grid-cols-1 xl:grid-cols-8">
                <Card className="gap-5 overflow-hidden rounded-none border-0 border-b border-foreground/10 ring-0 xl:col-span-4 xl:border-r">
                    <CardHeader>
                ...
                <Card className="gap-5 overflow-hidden rounded-none border-0 border-b border-foreground/10 ring-0 xl:col-span-4">
                    <CardHeader>
