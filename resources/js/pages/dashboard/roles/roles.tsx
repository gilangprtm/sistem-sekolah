...
export function Roles({ roles }: { roles: Role[] }) {
    ...
    const ownerFilter =
        (table.getColumn('owner')?.getFilterValue() as string | undefined) ??
        'All';
    const statusFilter =
        ...
        <div className="flex h-full flex-col gap-4">
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:justify-between">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Manage access roles and permissions across your
                        organization.
                    </p>
                </div>
            ...
            <Tabs className="h-full gap-4" defaultValue="roles">
                ...
                >
                    ...
                    <TabsTrigger value="access-reviews">
                        Access reviews
                    </TabsTrigger>
                </TabsList>
                                    ...
                                    >
                                        ...
                                        >
                                            <SelectGroup>
                                                ...
                                                <SelectItem value="Alex Kim">
                                                    Alex Kim
                                                </SelectItem>
                                                <SelectItem value="Chris Lee">
                                                    Chris Lee
                                                </SelectItem>
                                            </SelectGroup>
                                        </SelectContent>
